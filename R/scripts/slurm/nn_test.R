...
files <- read_csv("/homes/lcwatson/R/coconuts_thesis/data/test_files.csv") |> pull(file_name)
...
for (file in files) {
  # get expanded file
  d <- read_csv(paste0("/homes/lcwatson/R/coconuts_thesis/", file), show_col_types = F)
