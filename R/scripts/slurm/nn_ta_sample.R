# model choices as function of distance, ta, and pv
...
dat$Feature_matrix[, , 3] <- coconut_pv
...
nn_ta_fit <- m_parallel$sample(
  dat,
  chains = 2, parallel_chains = 2, threads_per_chain = 16,
  refresh = 50, iter_warmup = 500, adapt_delta = 0.99, iter_sampling = 1500,
  output_dir = "/homes/lcwatson/R/coconuts_thesis/cmdstan_output",
  output_basename = "nn_ta_model",
  seed = 888
)
